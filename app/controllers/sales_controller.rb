class SalesController < ApplicationController
  ...
  def index
    ...
    @sales_near_by = Sale.find_by_sql ["SELECT * FROM sales s WHERE earth_box(ll_to_earth(?,?),?) @> ll_to_earth(s.latitude,s.longitude)",params[:latitude],params[:longitude],params[:proximity]]    
